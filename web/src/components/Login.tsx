  ...
  return (
    <div className='flex h-full items-center justify-center p-6'>
      <div className='w-full max-w-sm rounded-xl border border-slate-800 bg-slate-900/60 p-6'>
        <h1 className='mb-1 text-lg font-semibold text-slate-100'>CRM 管理系统</h1>
        <p className='mb-5 text-xs text-slate-500'>用 CRM 账号登录，管理线索、客户、商机与任务。</p>
        ...
        <p className='mt-4 text-xs text-slate-500'>
          初始管理员由 CRM_BOOTSTRAP_ADMIN_EMAIL / CRM_BOOTSTRAP_ADMIN_PASSWORD 决定。
        </p>
      </div>
    </div>
  );
