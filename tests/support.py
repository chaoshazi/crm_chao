...
REP_EMAIL = 'zhoumin@example.com'
DEMO_PASSWORD = 'sales12345'

# 与 D:/codex 的 fake 演示数据保持一致的固定 ID
SEED_IDS = {
    'accounts': ['acc-0001'],
    'leads': ['lead-0001', 'lead-0002'],
    'opportunities': ['opp-0001'],
    'activities': ['act-0001'],
    'tasks': ['task-0001'],
    'notes': ['note-0001'],
}
...
def make_settings(tmpdir: str, **overrides: Any) -> Settings:
    ...
    values: dict[str, Any] = {
        'storage': 'sqlite',
        'sqlite_path': str(Path(tmpdir) / 'crm-test.sqlite3'),
        'serve_web': False,
        'seed_demo': True,
...
@contextmanager
def crm(**overrides: Any) -> Iterator[tuple[TestClient, Settings]]:
