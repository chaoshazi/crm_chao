...
- CRM 前端：额外的 q/stage/owner_id/team_id/order/page 等筛选与排序参数。
'''
...
from app.contract import OBJECT_NAMES, get_object, meta_payload
...
api_router = APIRouter(prefix='/api/v1', tags=['crm'])
